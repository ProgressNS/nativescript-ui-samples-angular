...
export const routes: Routes = [
  { path: 'grid-lines', component: ChartAnnotationsGridLineComponent },
  { path: 'plot-band', component: ChartAnnotationsPlotBandComponent },
  { path: 'axis-customization', component: ChartAxesCustomizationComponent },
  { path: 'axis-datetime', component: ChartAxesDateTimeComponent },
  { path: 'axis-multiple', component: ChartAxesMultipleComponent },
  { path: 'axis-negative', component: ChartAxesNegativeValuesComponent },
  { path: 'pie-selection', component: ChartBehaviorsChartPieSelectionComponent },
  { path: 'datapoint-selection', component: ChartBehaviorsDatapointSelectionComponent },
  { path: 'pan-zoom', component: ChartBehaviorsPanZoomComponent },
  { path: 'series-selection', component: ChartBehaviorsSeriesSelectionComponent },
  { path: 'trackball', component: ChartBehaviorsTrackballComponent },
  { path: 'legend', component: ChartLegendComponent },
  { path: 'series-area', component: ChartSeriesAreaComponent },
  { path: 'series-stacked-area', component: ChartSeriesStackedAreaComponent },
  { path: 'series-bar', component: ChartSeriesBarComponent },
  { path: 'series-range-bar', component: ChartSeriesRangeBarComponent },
  { path: 'series-stacked-bar', component: ChartSeriesStackedBarComponent },
  { path: 'series-bubble', component: ChartSeriesBubbleComponent },
  { path: 'series-scatter-bubble', component: ChartSeriesScatterBubbleComponent },
  { path: 'series-candlestick', component: ChartSeriesCandlestickComponent },
  { path: 'series-ohlc', component: ChartSeriesOhlcComponent },
  { path: 'series-line', component: ChartSeriesLineComponent },
  { path: 'series-pie', component: ChartSeriesPieComponent },
  { path: 'series-scatter', component: ChartSeriesScatterComponent },
  { path: 'series-spline-area', component: ChartSeriesSplineAreaComponent },
  { path: 'series-spline', component: ChartSeriesSplineComponent },
  { path: 'styling-axis', component: ChartStylingAxesComponent },
  { path: 'styling-grid', component: ChartStylingGridComponent },
  { path: 'styling-label', component: ChartStylingLabelComponent },
  { path: 'styling-pie-series', component: ChartStylingPieSeriesComponent },
  { path: 'styling-selection', component: ChartStylingSelectionComponent },
  { path: 'styling-series', component: ChartStylingSeriesComponent }
];